...
where time column in the hills file starts from zero at every restart. It is possible to
set `ignoretime=T` in the `red.hills` function. It will take the time of the first hill
and use it as the 
