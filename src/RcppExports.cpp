...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<double> >::type cv1(cv1SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type cv2(cv2SEXP);
    Rcpp::traits::input_parameter< double >::type width1(width1SEXP);
    Rcpp::traits::input_parameter< double >::type width2(width2SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type heights(heightsSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<double> >::type cv1(cv1SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type cv2(cv2SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type width1(width1SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type width2(width2SEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type heights(heightsSEXP);
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    Rcpp::traits::input_parameter< int >::type tmin(tminSEXP);
    Rcpp::traits::input_parameter< int >::type tmax(tmaxSEXP);
